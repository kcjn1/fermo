...
Create a polished macOS dark-mode design with these screens: menu bar popover, dashboard, start contract flow, preset picker, Focus Room builder, blocklist editor, active session screen, break-glass dialog, proof capture, evidence log/history, permissions/onboarding, preferences, empty states, and error states.
